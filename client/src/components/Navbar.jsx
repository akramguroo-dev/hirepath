  ...
  return (
    <nav className="flex items-center justify-between bg-white text-black px-5">
      ...
      <div className="flex gap-4">
        <Link
          to="/login"
          className="px-5 py-2 text-[#008BDC] border border border-[#008BDC] rounded font-semibold leading-none"
        >
          Login
        </Link>
        <Link
          to="/register"
          className="px-4 py-2 bg-[#00A5EC] text-white rounded font-semibold leading-none"
        >
          Register
        </Link>
      </div>
