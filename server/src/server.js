...
// ============================================
// Runs every hour (more reliable than daily on Render free tier,
// which spins down and may miss a single daily trigger)
cron.schedule("0 * * * *", async () => {
  try {
    ...
    console.log(
      `[CRON] Job auto-close completed. ${closedCount} job(s) closed.`,
    );
  } catch (error) {
